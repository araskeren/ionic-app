                ...
                <ion-label @click="todoPinia.toggleTodo(item.id)">
                  <div v-if="item.isEditMode">
                    <ion-input
                      type="text"
                      v-model="item.text"
                      @keyup.enter="todoPinia.updateTodo(item.id, item.text)"
                    ></ion-input>
                  </div>
                  <div
                    v-else
                  ...
                  >
                    <ion-checkbox
                      ...
                      @ionChange="todoPinia.toggleTodo(item.id)"
                    ></ion-checkbox>
                    {{ item.text }}
                  </div>
                </ion-label>
                <ion-button @click="todoPinia.toggleEdit(item.id)" slot="end"
                  >Edit</ion-button
                >
                <ion-button @click="todoPinia.deleteTodo(item.id)" slot="end"
                  >X</ion-button
                >
              </ion-item>
            </ion-list>
